...
class User
{
    ...
    public static function displayUserInfos($id)
    {
        ...
        foreach ($result as $userInfo) { ?>
            ...
            <div class=user>
                <div>
                    <img class="profilePicture" src =" <?php echo 'data:image/jpg;base64,' . base64_encode($userInfo['user_img'])?>"/>
                </div>
                <div class=username>
                    <h2 class=hUsername><?php echo $userInfo['username'];?></h2>
                </div>
                <div class="userInfo">
                    <p>E-mail : <?php  echo $userInfo['user_email'];?></p>
                    <p>Age : <?php  echo $userInfo['user_age'];?></p>
                    <p>Mot de passe : <input class="noBack" type="password" value="<?php  echo $userInfo['user_pdw'];?>" disabled/> </p> 
                    <p>Nombre d'enchères : <?php  echo $userInfo['nbr_bids'];?></p>
                    <p>Nombre d'annonces : <?php  echo $userInfo['nbr_object'];?></p>
