            ...
            <form  action="" method="POST" enctype="multipart/form-data">
              <div class="row ">
                ...
                <div class="col-6">
                  ...
                  <div class="mb-3">
                    <input type="hidden" class="form-control" id="date" name="date" value="<?php echo date("Y-m-d H:i:s") ?>" >
                  </div>
                  <div class="mb-3">
...
<footer class="fixed-bottom bg-dark d-flex justify-content-center colorWhite"><p>Copyright CBNC</p></footer>
</body>
</html>